...
const App = () => {
    ...
    const addItem = (data) => { 
        console.log(data)
        dispatch(addItemToCart(data)) //send data
    }

    const items = useSelector(state => state.items) // fecting data
    ...
    const renderItem = ({ item }) => {
        ...
        <View style={styles.productContainer}>
            ...
            <Button  onPress={()=>addItem(item)} title='Add to cart' disabled={isInCart}>
